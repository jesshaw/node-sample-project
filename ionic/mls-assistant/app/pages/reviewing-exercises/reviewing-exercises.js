...
*/
var ReviewingExercisesPage = (function () {
    function ReviewingExercisesPage(nav, homeworkService) {
        var _this = this;
        this.nav = nav;
    ...
    ReviewingExercisesPage.prototype.itemTapped = function (event, item) {
        // That's right, we're pushing to ourselves!
        this.nav.push(homework_1.HomeworkPage, {
            item: item
        });
    };
    ReviewingExercisesPage = __decorate([
        core_1.Component({
    ...
    ], ReviewingExercisesPage);
    return ReviewingExercisesPage;
}());
exports.ReviewingExercisesPage = ReviewingExercisesPage;
