...
var ExercisesPage = (function () {
    function ExercisesPage(nav, homeworkService) {
        var _this = this;
        this.nav = nav;
    ...
    ExercisesPage.prototype.itemTapped = function (event, item) {
        // That's right, we're pushing to ourselves!
        this.nav.push(homework_1.HomeworkPage, {
            item: item
        });
    };
    ExercisesPage = __decorate([
        core_1.Component({
...
exports.ExercisesPage = ExercisesPage;
