...
## post test
curl --data "username=gonto&password=gonto" http://localhost:3001/sessions/createToken

## post json data
curl -H "Content-Type: application/json" -X POST -d '{"wxUsername":"test"}' http://localhost:3000/api/login
